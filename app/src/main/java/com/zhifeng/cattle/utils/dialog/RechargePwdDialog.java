...
import com.zhifeng.cattle.adapters.KeyBoardAdapter;
import com.zhifeng.cattle.utils.view.OnPasswordInputFinish;
import com.zhifeng.cattle.utils.view.VirtualKeyboardView;
...
public class RechargePwdDialog extends Dialog implements DialogInterface.OnDismissListener{
    ...
    public RechargePwdDialog(@NonNull Context context , int themeResId,double money) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_recharge_pwd);
